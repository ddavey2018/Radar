                        ...
                        if ("scroll" === M) {
                            ...
                            y) {
                                ...
                                if (a(r).isSVG || "tween" === z || !1 !== b.Names.prefixCheck(z)[1] || b.Normalizations.registered[z] !== n) {
                                    (c.display !== n && null !== c.display && "none" !== c.display || c.visibility !== n && "hidden" !== c.visibility) && /opacity|filter/.test(O) && !N && 0 !== W && (N = 0),
                                    c._cacheValues && D && D[O] ? (N === n && (N = D[O].endValue + D[O].unitType),
                                    V = a(r).rootPropertyValueCache[z]) : b.Hooks.registered[O] ? N === n ? (V = b.getPropertyValue(r, z),
                                    N = b.getPropertyValue(r, O, V)) : V = b.Hooks.templates[z][1] : N === n && (N = b.getPropertyValue(r, O));
                                    var B, j, Y, $ = !1;
                                    if (N = (B = p(O, N))[0],
                                    Y = B[1],
...
function(t) {
    ...
    return function t(e, i, n) {
        ...
        7: [function(t, e, i) {
            ...
            t(14)(n);
            var o = [];
            o.push(t(49)(n), t(50)(n), t(51)(n)),
            n.plugins.register(o),
        ...
        15: [function(t, e, i) {
            ...
            e.exports = function(t) {
                t.controllers.bar = t.DatasetController.extend({
                    ...
                    getRuler: function() {
                        var t, e, i = this.getIndexScale(), n = this.getStackCount(), o = this.index, a = [], r = i.isHorizontal(), s = r ? i.left : i.top, l = s + (r ? i.width : i.height);
                        for (t = 0,
                        e = this.getMeta().data.length; t < e; ++t)
                            a.push(i.getPixelForValue(null, t, o));
                        return {
                            pixels: a,
                            start: s,
                            end: l,
                    ...
                    calculateBarValuePixels: function(t, e) {
                        var i, n, o, a, r, s, l = this.chart, c = this.getMeta(), u = this.getValueScale(), d = l.data.datasets, h = u.getRightValue(d[t].data[e]), f = u.options.stacked, p = c.stack, m = 0;
                    ...
                    calculateBarIndexPixels: function(t, e, i) {
                        var n, o, r, s, l, c = i.scale.options, u = this.getStackIndex(t), d = i.pixels, h = d[e], f = d.length, p = i.start, m = i.end;
                        return 1 === f ? (n = h > p ? h - p : m - h,
                        o = h < m ? m - h : h - p) : (e > 0 && (n = (h - d[e - 1]) / 2,
                        e === f - 1 && (o = n)),
                        e < f - 1 && (o = (d[e + 1] - h) / 2,
                        0 === e && (n = o))),
                        l = (s = ((r = n * c.categoryPercentage) + o * c.categoryPercentage) / i.stackCount) * c.barPercentage,
                        h -= r,
                        h += s * u,
                        {
            ...
            e.exports = function(t) {
                t.controllers.bubble = t.DatasetController.extend({
                    ...
                    _resolveElementOptions: function(t, e) {
                        var i, n, o, r = this.chart, s = r.data.datasets[this.index], l = t.custom || {}, c = r.options.elements.point, u = a.options.resolve, d = s.data[e], h = {}, f = {
                            chart: r,
                            dataIndex: e,
                            dataset: s,
        ...
        18: [function(t, e, i) {
            ...
            e.exports = function(t) {
                ...
                t.controllers.line = t.DatasetController.extend({
                    ...
                    dataElementType: o.Point,
                    update: function(t) {
                        var i, n, o, r = this, s = r.getMeta(), l = s.dataset, c = s.data || [], u = r.chart.options, d = u.elements.line, h = r.getScaleForId(s.yAxisID), f = r.getDataset(), p = e(f, u);
                        for (p && (o = l.custom || {},
                    ...
                    updateElement: function(t, e, i) {
                        var n, o, r = this, s = r.getMeta(), l = t.custom || {}, c = r.getDataset(), u = r.index, d = c.data[e], h = r.getScaleForId(s.yAxisID), f = r.getScaleForId(s.xAxisID), p = r.chart.options.elements.point;
            ...
            e.exports = function(t) {
                ...
                o.extend(t.prototype, {
                    ...
                    resize: function(t) {
                        ...
                        if ((i.width !== s || i.height !== l) && (a.width = i.width = s,
                        a.height = i.height = l,
                        a.style.width = s + "px",
                        a.style.height = l + "px",
                        o.retinaScale(i, n.devicePixelRatio),
                        !t)) {
                            var c = {
                                width: s,
                                height: l
                            ...
                            e.notify(i, "resize", [c]),
                            i.options.onResize && i.options.onResize(i, c),
                            i.stop(),
                    ...
                    updateLayout: function() {
                        !1 !== e.notify(this, "beforeLayout") && (t.layoutService.update(this, this.width, this.height),
                        e.notify(this, "afterScaleUpdate"),
                        e.notify(this, "afterLayout"))
                    },
                    ...
                    updateDataset: function(t) {
                        ...
                        !1 !== e.notify(this, "beforeDatasetUpdate", [n]) && (i.controller.update(),
                        e.notify(this, "afterDatasetUpdate", [n]))
                    },
                    render: function(i) {
                        var n = this;
                        i && "object" == typeof i || (i = {
                        ...
                        if (!1 !== e.notify(n, "beforeRender")) {
                            var s = n.options.animation
                              , l = function(t) {
                                e.notify(n, "afterRender"),
                                o.callback(s && s.onComplete, [t], n)
                            };
                    ...
                    draw: function(t) {
                        ...
                        i.transition(t),
                        !1 !== e.notify(i, "beforeDraw", [t]) && (o.each(i.boxes, function(t) {
                            t.draw(i.chartArea)
                        }, i),
                        i.scale && i.scale.draw(),
                        i.drawDatasets(t),
                        i._drawTooltip(t),
                        e.notify(i, "afterDraw", [t]))
                    },
                    ...
                    drawDatasets: function(t) {
                        ...
                        if (!1 !== e.notify(i, "beforeDatasetsDraw", [t])) {
                            for (var n = (i.data.datasets || []).length - 1; n >= 0; --n)
                                i.isDatasetVisible(n) && i.drawDataset(n, t);
                    ...
                    drawDataset: function(t, i) {
                        ...
                        !1 !== e.notify(this, "beforeDatasetDraw", [o]) && (n.controller.draw(i),
                        e.notify(this, "afterDatasetDraw", [o]))
                    },
                    _drawTooltip: function(t) {
                        ...
                        !1 !== e.notify(this, "beforeTooltipDraw", [n]) && (i.draw(),
                        e.notify(this, "afterTooltipDraw", [n]))
                    },
                    ...
                    destroy: function() {
                        ...
                        for (a.stop(),
                        i = 0,
                        n = a.data.datasets.length; i < n; ++i)
                            a.destroyDatasetMeta(i);
                        s && (a.unbindEvents(),
                        o.canvas.clear(a),
                        r.releaseContext(a.ctx),
                        a.canvas = null,
                        a.ctx = null),
                        e.notify(a, "destroy"),
                    ...
                    eventHandler: function(t) {
                        ...
                        if (!1 !== e.notify(i, "beforeEvent", [t])) {
                            ...
                            o |= n && n.handleEvent(t),
                            e.notify(i, "afterEvent", [t]);
                            var a = i._bufferedRequest;
                            return a ? i.render(a) : o && !i.animating && (i.stop(),
                            i.render(i.options.hover.animationDuration, !0)),
                            i._bufferedRender = !1,
                            i._bufferedRequest = null,
                            i
                        }
            ...
            e.exports = function(t) {
                ...
                t.Scale = o.extend({
                    ...
                    _autoSkip: function(t) {
                        var e, i, n, o, r = this, s = r.isHorizontal(), l = r.options.ticks.minor, c = t.length, u = a.toRadians(r.labelRotation), d = Math.cos(u), h = r.longestLabelWidth * d, f = [];
                        ...
                        if (o.display) {
                            ...
                            if (a.each(g, function(i, n) {
                                if (!a.isNullOrUndef(i.label)) {
                                    ...
                                    if (m) {
                                        var H = w + W;
                                        "bottom" === o.position ? (R = p ? "middle" : "top",
                                        F = p ? "right" : "center",
                                        O = e.top + H) : (R = p ? "middle" : "bottom",
                                        F = p ? "left" : "center",
                                        O = e.bottom - H);
                                        ...
                                        u.mirror ? (F = V ? "left" : "right",
                                        z = W) : (F = V ? "right" : "left",
                                        z = w + W),
                                        E = V ? e.right - z : e.left + z;
                                        var B = l(e, n, h.offsetGridLines && g.length > 1);
                                        B < e.top && (s = "rgba(0,0,0,0)"),
                                        B += a.aliasPixel(r),
                            ...
                            f.display) {
                                ...
                                if (m)
                                    ...
                                    E = "bottom" === o.position ? e.bottom - L - S.bottom : e.top + L + S.top;
                                else {
                                    var F = "left" === o.position;
                                    _ = F ? e.left + L + S.top : e.right - L - S.top,
                                    E = e.top + (e.bottom - e.top) / 2,
                                    O = F ? -.5 * Math.PI : .5 * Math.PI
                                }
                                s.save(),
                                s.translate(_, E),
                                s.rotate(O),
                            ...
                            if (h.drawBorder) {
                                ...
                                m ? (H = N = "top" === o.position ? e.bottom : e.top,
                                H += z,
                                N += z) : (R = W = "left" === o.position ? e.right : e.left,
                                R += z,
                                W += z),
                                s.beginPath(),
                                s.moveTo(R, H),
                ...
                t.scaleService = {
                    ...
                    addScalesToLayout: function(e) {
                        o.each(e.scales, function(i) {
                            i.fullWidth = i.options.fullWidth,
                            i.position = i.options.position,
                            i.weight = i.options.weight,
                ...
                generators: {
                    ...
                    logarithmic: function(t, e) {
                        ...
                        do {
                            ...
                            ++i),
                            s = o * Math.pow(10, i)
                        } while (i < l || i === l && o < c);var u = r(t.max, s);
                        return a.push(u),
                        a
                    }
                },
        ...
        35: [function(t, e, i) {
            ...
            e.exports = function(t) {
                ...
                t.Tooltip = o.extend({
                    ...
                    update: function(e) {
                        var i, n, o, s, l, c, u, d = this, h = d._options, f = d._model, p = d._model = r(h), m = d._active, g = d._data, v = {
                            xAlign: f.xAlign,
                            yAlign: f.yAlign
                        }, y = {
                            x: f.x,
                        ...
                        if (m.length) {
                            ...
                            y = function(t, e, i) {
                                var n = t.x
                                  ...
                                  , u = a + r
                                  , d = s + r;
                                return "right" === l ? n -= e.width : "center" === l && (n -= e.width / 2),
                                "top" === c ? o += u : o -= "bottom" === c ? e.height + u : e.height / 2,
                                "center" === c ? "left" === l ? n += u : "right" === l && (n -= u) : "left" === l ? n -= d : "right" === l && (n += d),
                                {
                                    x: n,
                                    y: o
                                }
                    ...
                    getCaretPosition: function(t, e, i) {
                        var n, o, a, r, s, l, c = i.caretSize, u = i.cornerRadius, d = i.xAlign, h = i.yAlign, f = t.x, p = t.y, m = e.width, g = e.height;
                        if ("center" === h)
                            s = p + g / 2,
                            "left" === d ? (o = (n = f) - c,
                            a = n,
                    ...
                    handleEvent: function(t) {
                        ...
                        "mouseout" === t.type ? e._active = [] : e._active = e._chart.getElementsAtEventForMode(t, i.mode, i),
                        !(n = !a.arrayEquals(e._active, e._lastActive)))
                            return !1;
        ...
        49: [function(t, e, i) {
            ...
            e.exports = function() {
                ...
                function s(e) {
                    var i = e.fill
                      , n = "dataset";
                    return !1 === i ? null : (isFinite(i) || (n = "boundary"),
                    t[n](e))
                }
                function l(t) {
                    return t && !t.skip
                ...
                return {
                    ...
                    afterDatasetsUpdate: function(t, n) {
                        ...
                        for (l = 0; l < d; ++l)
                            u = null,
                            (c = (a = t.getDatasetMeta(l)).dataset) && c._model && c instanceof o.Line && (u = {
                    ...
                    beforeDatasetDraw: function(t, e) {
                        ...
                        if (i) {
                            ...
                            d && h && u.length && (a.canvas.clipArea(o, t.chartArea),
                            function(t, e, i, n, o, a) {
                                var r, s, u, d, h, f, p, m = e.length, g = n.spanGaps, v = [], y = [], b = 0, x = 0;
                                for (t.beginPath(),
                                r = 0,
                                s = m + !!a; r < s; ++r)
                                    h = i(d = e[u = r % m]._view, u, n),
                                    f = l(d),
                                    p = l(h),
                                    f && p ? (b = v.push(d),
                                    x = y.push(h)) : b && x && (g ? (f && v.push(d),
                                    p && y.push(h)) : (c(t, v, y, b, x),
                                    b = x = 0,
                                    v = [],
                                    y = []));
                                c(t, v, y, b, x),
                ...
                return t.Legend = o.extend({
                    ...
                    draw: function() {
                        var t = this
                          ...
                          , c = t.lineWidths;
                        if (e.display) {
                            var u, d = t.ctx, h = a.valueOrDefault, f = h(i.fontColor, o.defaultFontColor), p = h(i.fontSize, o.defaultFontSize), m = h(i.fontStyle, o.defaultFontStyle), g = h(i.fontFamily, o.defaultFontFamily), v = a.fontString(p, m, g);
                            d.textAlign = "left",
                            ...
                            a.each(t.legendItems, function(n, r) {
                                ...
                                x ? g + m >= l && (v = u.y += w,
                                u.line++,
                                g = u.x = t.left + (l - c[u.line]) / 2) : v + w > t.bottom && (g = u.x = g + t.columnWidths[u.line] + i.padding,
                                ...
                                function(t, i, n) {
                                    if (!(isNaN(y) || y <= 0)) {
                                        ...
                                        d.lineCap = h(n.lineCap, s.borderCapStyle),
                                        d.lineDashOffset = h(n.lineDashOffset, s.borderDashOffset),
                                        d.lineJoin = h(n.lineJoin, s.borderJoinStyle),
                                        d.lineWidth = h(n.lineWidth, s.borderWidth),
                                        d.strokeStyle = h(n.strokeStyle, o.defaultColor);
                                        var r = 0 === h(n.lineWidth, s.borderWidth);
                                        if (d.setLineDash && d.setLineDash(h(n.lineDash, s.borderDash)),
                ...
                }),
                {
                    ...
                    beforeUpdate: function(t) {
                        var i = t.options.legend
                          , o = t.legend;
                        i ? (a.mergeIf(i, n.global.legend),
                        o ? (e.configure(t, o, i),
                        o.options = i) : s(t, i)) : o && (e.removeBox(t, o),
                        delete t.legend)
                    },
                ...
                return t.Title = o.extend({
                    ...
                    draw: function() {
                        var t = this
                          ...
                          , r = n.global;
                        if (o.display) {
                            var s, l, c, u = i(o.fontSize, r.defaultFontSize), d = i(o.fontStyle, r.defaultFontStyle), h = i(o.fontFamily, r.defaultFontFamily), f = a.fontString(u, d, h), p = a.options.toLineHeight(o.lineHeight, u), m = p / 2 + o.padding, g = 0, v = t.top, y = t.left, b = t.bottom, x = t.right;
                ...
                }),
                {
                    ...
                    beforeUpdate: function(i) {
                        var o = i.options.title
                          , s = i.titleBlock;
                        o ? (a.mergeIf(o, n.global.title),
                        s ? (e.configure(i, s, o),
                        s.options = o) : r(i, o)) : s && (t.layoutService.removeBox(i, s),
                        delete i.titleBlock)
                    }
                }
            }
                ...
                var e = {
                  ...
                  , i = t.LinearScaleBase.extend({
                    ...
                    getPixelForValue: function(t) {
                        ...
                        return i.isHorizontal() ? (e = i.left + i.width / a * (o - n),
                        Math.round(e)) : (e = i.bottom - i.height / a * (o - n),
                        Math.round(e))
                    },
                    getValueForPixel: function(t) {
                        var e = this
                ...
                var e = {
                  ...
                  , i = t.Scale.extend({
                    determineDataLimits: function() {
                        ...
                        e.stacked || c) {
                            ...
                            n.each(a, function(i, a) {
                                ...
                                o.isDatasetVisible(a) && l(r) && (void 0 === u[s] && (u[s] = []),
                                n.each(i.data, function(i, n) {
                                    var o = u[s]
                                      , a = +t.getRightValue(i);
                                    isNaN(a) || r.data[n].hidden || (o[n] = o[n] || 0,
                                    e.relativePoints ? o[n] = 100 : o[n] += a)
                                }))
                            }),
                            n.each(u, function(e) {
                                var i = n.min(e)
                    ...
                    getPixelForValue: function(t) {
                        ...
                        return a.isHorizontal() ? (o = n.log10(a.end) - n.log10(r),
                        0 === s ? i = a.left : (e = a.width,
                        i = a.left + e / o * (n.log10(s) - n.log10(r)))) : (e = a.height,
                        0 !== r || l.reverse ? 0 === a.end && l.reverse ? (o = n.log10(a.start) - n.log10(a.minNotZero),
                        i = s === a.end ? a.top : s === a.minNotZero ? a.top + .02 * e : a.top + .02 * e + .98 * e / o * (n.log10(s) - n.log10(a.minNotZero))) : 0 === s ? i = l.reverse ? a.top : a.bottom : (o = n.log10(a.end) - n.log10(r),
                        e = a.height,
                        i = a.bottom - e / o * (n.log10(s) - n.log10(r))) : (o = n.log10(a.end) - n.log10(a.minNotZero),
                        i = s === r ? a.bottom : s === a.minNotZero ? a.bottom - .02 * e : a.bottom - .02 * e - .98 * e / o * (n.log10(s) - n.log10(a.minNotZero)))),
                        i
                    },
                    getValueForPixel: function(t) {
                        var e, i, o = this, a = n.log10(o.end) - n.log10(o.start);
                        return o.isHorizontal() ? (i = o.width,
                        e = o.start * Math.pow(10, (t - o.left) * a / i)) : (i = o.height,
                        e = Math.pow(10, (o.bottom - t) * a / i) / o.start),
                        e
                    }
                });
                                ...
                                for (var m = r(t) - 1; m >= 0; m--) {
                                    ...
                                    if (h.display) {
                                        ...
                                        var b = t.getIndexAngle(m)
                                          , x = o.toDegrees(b);
                                        i.textAlign = c(x),
                                        d(x, t._pointLabelSizes[m], v),
                                        u(i, t.pointLabels[m] || "", v, p.size)
                                    }
                                }
                            }(t)
                        }
        ...
        57: [function(t, e, i) {
                ...
                var r, u = o.time, d = u.unit || function(t, e, i, n) {
                    ...
                    for (o = c.indexOf(t); o < u - 1; ++o)
                        ...
                        a.common && Math.ceil((i - e) / (r * a.size)) <= n)
                            return c[o];
                    return c[u - 1]
                }(u.minUnit, t, e, i), h = m(d), f = a.valueOrDefault(u.stepSize, u.unitStepSize), p = "week" === d && u.isoWeekday, g = o.ticks.major.enabled, v = l[d], y = n(t), b = n(e), x = [];
                for (f || (f = function(t, e, i, n) {
                    var o, a, r, s = e - t, c = l[i], u = c.size, d = c.steps;
                    if (!d)
                        return Math.ceil(s / ((n || 1) * u));
                    for (o = 0,
            ...
            e.exports = function(t) {
                var e = t.Scale.extend({
                    ...
                    determineDataLimits: function() {
                        var t, e, i, o, l, c, h = this, f = h.chart, m = h.options.time, g = s, v = r, y = [], b = [], x = [];
                        for (t = 0,
                        i = f.data.labels.length; t < i; ++t)
                            x.push(p(f.data.labels[t], h));
                        for (t = 0,
                        i = (f.data.datasets || []).length; t < i; ++t)
                            if (f.isDatasetVisible(t))
                                ...
                                b[t] = [];
                        x.length && (x = d(x).sort(u),
                        g = Math.min(g, x[0]),
                        v = Math.max(v, x[x.length - 1])),
                        y.length && (y = d(y).sort(u),
                        g = Math.min(g, y[0]),
                        v = Math.max(v, y[y.length - 1])),
                        g = p(m.min, h) || g,
                        v = p(m.max, h) || v,
                        g = g === s ? +n().startOf("day") : g,
                        v = v === r ? +n().endOf("day") + 1 : v,
                        h.min = Math.min(g, v),
                        h.max = Math.max(g + 1, v),
                    ...
                    getLabelForIndex: function(t, e) {
                        ...
                        n.tooltipFormat && (o = f(o, n).format(n.tooltipFormat)),
                        o
                    },
...
function(t, e) {
    ...
    var l = {
        ...
        hide: function(t, e) {
            for (var i = (e = e || this).getElementsByClassName("waves-rippling"), n = 0, o = i.length; n < o; n++)
                u(t, e, i[n])
        }
    }
      , c = {
...
function(t, e, i, n) {
    ...
    v(ht, Z, {
        handler: function(t) {
            ...
            o & R && (0 === t.button || r) ? s < 0 && (e.push(t),
            s = e.length - 1) : o & (H | N) && (i = !0),
            s < 0 || (e[s] = t,
    ...
    v(gt, Z, {
        handler: function(t) {
            ...
            this.started) {
                ...
                .call(this, t, e);
                e & (H | N) && i[0].length - i[1].length == 0 && (this.started = !1),
                this.callback(this.manager, e, {
                    pointers: i[0],
                    changedPointers: i[1],
                    pointerType: "touch",
    ...
    v(kt, Z, {
        handler: function(t, e, i) {
            ...
            if (!(o && i.sourceCapabilities && i.sourceCapabilities.firesTouchEvents)) {
                if (n)
                    (function(t, e) {
                        t & R ? (this.primaryTouch = e.changedPointers[0].identifier,
                        Ct.call(this, e)) : t & (H | N) && Ct.call(this, e)
                    }
                    ).call(this, e, i);
    ...
    Nt.prototype = {
        ...
        recognize: function(t) {
            ...
            if (!b(this.options.enable, [this, e]))
                return this.reset(),
                void (this.state = 32);
            this.state & (Wt | Ht | 32) && (this.state = Ot),
            this.state = this.process(e),
            this.state & (Lt | Ft | Rt | Ht) && this.tryEmit(e)
        },
        process: function(t) {},
    ...
    v(Yt, jt, {
        ...
        directionTest: function(t) {
            var e = this.options
              ...
              , a = t.deltaX
              , r = t.deltaY;
            return o & e.direction || (e.direction & $ ? (o = 0 === a ? z : a < 0 ? V : B,
            i = a != this.pX,
            n = Math.abs(t.deltaX)) : (o = 0 === r ? z : r < 0 ? j : Y,
            i = r != this.pY,
            n = Math.abs(t.deltaY))),
            t.direction = o,
    ...
    v(Xt, Nt, {
        ...
        emit: function(t) {
            this.state === Wt && (t && t.eventType & H ? this.manager.emit(this.options.event + "up", t) : (this._input.timeStamp = u(),
    ...
    v(Ut, jt, {
        ...
        attrTest: function(t) {
            ...
            this._super.attrTest.call(this, t) && i & t.offsetDirection && t.distance > this.options.threshold && t.maxPointers == this.options.pointers && c(e) > this.options.velocity && t.eventType & H
        },
        emit: function(t) {
        ...
        recognize: function(t) {
            ...
            if (!e.stopped) {
                ...
                for (var a = 0; a < n.length; )
                    ...
                    !o && i.state & (Lt | Ft | Rt) && (o = e.curRecognizer = i),
                    a++
            }
        },
        get: function(t) {
        ...
        t(this).each(function() {
            ...
            if (!n.hasClass("browser-default")) {
                ...
                "destroy" !== e) {
                    ...
                    var c, u, d = t('<ul id="select-options-' + s + '" class="dropdown-content select-dropdown ' + (o ? "multiple-select-dropdown" : "") + '"></ul>'), h = n.children("option, optgroup"), f = [], p = !1, m = n.find("option:selected").html() || n.find("option:first").html() || "", g = function() {
                    ...
                    var y = function(e, i, n) {
                        ...
                        if (r) {
                            var l = "";
                            return s && (l = ' class="' + s + '"'),
                            "multiple" === n ? d.append(t('<li class="' + o + '"><img alt="" src="' + r + '"' + l + '><span class="filtrable"><input type="checkbox"' + o + "/><label></label>" + i.html() + "</span></li>")) : d.append(t('<li class="' + o + a + '"><img alt="" src="' + r + '"' + l + '><span class="filtrable">' + i.html() + "</span></li>")),
                            !0
                        }
...
function(t) {
    ...
    o.prototype.validate = function(t, i, o) {
        var a, r, s, l, c = this, u = i, d = o && o.interval ? o.interval : 1, h = -1 === c.item.enable, f = c.item.min, p = c.item.max, m = h && c.item.disable.filter(function(t) {
            if (e.isArray(t)) {
    ...
    o.prototype.nodes = function(t) {
        var e, i, o = this, a = o.settings, r = o.item, s = r.now, l = r.select, c = r.highlight, u = r.view, d = r.disable, h = r.min, f = r.max, p = (e = (a.showWeekdaysFull ? a.weekdaysFull : a.weekdaysShort).slice(0),
            ...
            item: function(t) {
                ...
                return [n.group({
                    ...
                    item: function(t) {
                        ...
                        var e, i = l && l.pick == t.pick, r = c && c.pick == t.pick, p = d && o.disabled(t) || t.pick < h.pick || t.pick > f.pick, m = n.trigger(o.formats.toString, o, [a.format, t]);
...
function() {
    ...
    e.innerHTML = "",
    t), l = "transition"in (i = document.createElement("div").style) || "WebkitTransition"in i || "MozTransition"in i || "msTransition"in i || "OTransition"in i, c = "ontouchstart"in window, u = "mousedown" + (c ? " touchstart" : ""), d = "mousemove.clockpicker" + (c ? " touchmove.clockpicker" : ""), h = "mouseup.clockpicker" + (c ? " touchend.clockpicker" : ""), f = navigator.vibrate ? "vibrate" : navigator.webkitVibrate ? "webkitVibrate" : null;
    function p(t) {
    ...
    function S(t, e) {
        var i, o, r = n(C), l = r.find(".clockpicker-plate"), c = r.find(".picker__holder"), f = r.find(".clockpicker-hours"), S = r.find(".clockpicker-minutes"), M = r.find(".clockpicker-am-pm-block"), I = "INPUT" === t.prop("tagName"), P = I ? t : t.find("input"), A = (P.prop("type"),
    ...
    S.prototype.setHand = function(t, e, i, o) {
        var a, r, l = Math.atan2(t, -e), c = "hours" === this.currentView, u = Math.sqrt(t * t + e * e), d = this.options, h = c && u < (y + b) / 2, p = h ? b : y;
    ...
    return function(t, e, i, n) {
        ...
        var s, l, c, u, d, h, f, p, m, g, v, y, b, x, w, k, C, S, T, M, I, P, A, D, _, E, O, L, F, R, W, H, N, z, V, B, j, Y, $, X, q, U, Q, Z, G, K, J, tt, et, it, nt, ot, at, rt, st, lt = {
            ...
            close: function() {
                ...
                St("unbindEvents"),
                Ve(a.currItem, null, !0, a.destroy))
            },
            destroy: function() {
                St("destroy"),
                Fe && clearTimeout(Fe),
            ...
            updateSize: function(e) {
                ...
                void 0 !== h) {
                    for (var n, s, l, c = 0; 3 > c; c++)
                        ...
                        l = u + c - 1,
                        r.loop && ze() > 2 && (l = wt(l)),
                        (s = Ne(l)) && (w || s.needsUpdate || !s.bounds) ? (a.cleanSlide(s),
                        a.setContent(n, l),
                        1 === c && (a.currItem = s,
        ...
        }, Gt = {}, Kt = {}, Jt = {}, te = {}, ee = {}, ie = [], ne = {}, oe = [], ae = {}, re = 0, se = {
            x: 0,
            y: 0
        }, le = 0, ce = {
            x: 0,
            ...
            var t, e, i = {
                ...
                calculateSwipeSpeed: function(n) {
                    oe.length > 1 ? (t = Tt() - N + 50,
                    e = oe[oe.length - 2][n]) : (t = Tt() - H,
                    e = ee[n]),
                            ...
                            if (l.loadComplete = function(i) {
                                if (s) {
                                    if (t && t.index === e) {
                                        ...
                                        i.imageAppended ? !He && i.placeholder && (i.placeholder.style.display = "none",
                                        i.placeholder = null) : W.transform && (et || He) ? je.push({
                                            item: i,
                                            baseDiv: c,
                                            img: i.img,
                                            index: e,
...
function(t, e) {
    ...
    return function(t, e) {
        var i, n, o, a, r, s, l, c, u, d, h, f, p, m, g, v, y, b, x = this, w = !1, k = !0, C = !0, S = {
            ...
            for (var i, n, o = (t.target || t.srcElement).getAttribute("class") || "", a = 0; a < N.length; a++)
                (i = N[a]).onTap && o.indexOf("pswp__" + i.name) > -1 && (i.onTap(),
                n = !0);
            if (n) {
...
function(t) {
    ...
    var n, o, a = i("transform"), r = i("perspective"), s = navigator.userAgent, l = s.toLowerCase().indexOf("android") > -1, c = /iPad|iPhone|iPod/.test(s) && !t.MSStream, u = s.toLowerCase().indexOf("firefox") > -1, d = s.indexOf("MSIE ") > -1 || s.indexOf("Trident/") > -1 || s.indexOf("Edge/") > -1, h = document.all && !t.atob;
    function f() {
        n = t.innerWidth || document.documentElement.clientWidth,
    ...
    var p = []
      , m = function() {
        ...
        return function(e, i) {
            ...
            !(!a || l && this.options.noAndroid || c && this.options.noIos)) {
    ...
    m.prototype.css = function(e, i) {
        ...
        for (var n in i.transform && (r && (i.transform += " translateZ(0)"),
    ...
    m.prototype.init = function() {
        ...
        (n || "opacity" === t.options.type || "scale" === t.options.type || "scale-opacity" === t.options.type) && (t.image.position = "absolute"),
        i.position = t.image.position,
        t.css(t.image.$item, i),
        t.image.$container.appendChild(t.image.$item),
        t.image.width && t.image.height ? r() : t.getImageSize(t.image.src, function(e, i) {
            t.image.width = e,
            t.image.height = i,
            r()
        }),
    ...
    m.prototype.coverImage = function() {
        if (this.image.width && this.image.height) {
            var t = this.image.$container.getBoundingClientRect()
              ...
              , h = 0
              , f = 0;
            l && (c = s < 0 ? s * Math.max(i, o) : s * (i + o),
            s > 1 ? d = Math.abs(c - o) : s < 0 ? d = c / s + Math.abs(c) : d += Math.abs(o - i) * (1 - s),
            c /= 2),
            (u = d * a / r) < e && (d = (u = e) * r / a),
            l ? (h = n + (e - u) / 2,
            f = (o - d) / 2) : (h = (e - u) / 2,
            f = (i - d) / 2),
            "absolute" === this.image.position && (h -= n),
    ...
    m.prototype.onScroll = function(t) {
        if (this.image.width && this.image.height) {
            var e = this.$item.getBoundingClientRect()
              ...
              , s = e;
            if (this.options.elementInViewport && (s = this.options.elementInViewport.getBoundingClientRect()),
            this.isElementInViewport = s.bottom >= 0 && s.right >= 0 && s.top <= o && s.left <= n,
            t || this.isElementInViewport) {
                var l = Math.max(0, i)
                  ...
                  , p = 1 - 2 * (o - i) / (o + a)
                  , m = 1;
                if (a < o ? m = 1 - (u || d) / a : c <= o ? m = c / o : h <= o && (m = h / o),
                "opacity" !== this.options.type && "scale-opacity" !== this.options.type && "scroll-opacity" !== this.options.type || (r.transform = "",
                r.opacity = m),
                ...
                if ("scroll" === this.options.type || "scroll-opacity" === this.options.type) {
                    ...
                    r.transform = "translateY(" + v + "px)"
                }
                this.css(this.image.$item, r),
    ...
    g(t, "scroll", v),
    g(t, "resize", v),
    g(t, "orientationchange", v),
    g(t, "load", v);
    var y = function(t) {
        ("object" == typeof HTMLElement ? t instanceof HTMLElement : t && "object" == typeof t && null !== t && 1 === t.nodeType && "string" == typeof t.nodeName) && (t = [t]);
        for (var e, i = arguments[1], n = Array.prototype.slice.call(arguments, 2), o = t.length, a = 0; a < o; a++)
            if ("object" == typeof i || void 0 === i ? t[a].jarallax || (t[a].jarallax = new m(t[a],i)) : t[a].jarallax && (e = t[a].jarallax[i].apply(t[a].jarallax, n)),
            void 0 !== e)
                return e;
        return t
    };
...
function(t) {
                ...
                for (var e = 1; e < arguments.length; e++)
                    if (arguments[e])
                        for (var i in arguments[e])
                            arguments[e].hasOwnProperty(i) && (t[i] = arguments[e][i]);
                return t
            }({}, this.options_default, i),
            this.videoID = this.parseURL(e),
            this.videoID && (this.ID = t++,
            this.loadAPI(),
            this.init())
        }
    }();
    n.prototype.parseURL = function(t) {
        var e, i = !(!(e = t.match(/.*(?:youtu.be\/|v\/|u\/\w\/|embed\/|watch\?v=)([^#\&\?]*).*/)) || 11 !== e[1].length) && e[1], n = function(t) {
            ...
            for (var e = t.split(/,(?=mp4\:|webm\:|ogv\:|ogg\:)/), i = {}, n = 0, o = 0; o < e.length; o++) {
                ...
                a && a[1] && a[2] && (i["ogv" === a[1] ? "ogg" : a[1]] = a[2],
                n = 1)
            }
            return !!n && i
        }(t);
    ...
    n.prototype.getIframe = function(e) {
        ...
        n.$iframe ? e(n.$iframe) : n.onAPIready(function() {
            var o, a, r, s, l, c;
            if (n.$iframe || ((o = document.createElement("div")).style.display = "none"),
            "youtube" === n.type) {
                var u, d;
                n.playerOptions = {},
                ...
                n.playerOptions.events = {
                    ...
                    onStateChange: function(t) {
                        ...
                        u || t.data !== YT.PlayerState.PLAYING || (u = 1,
                        n.fire("started", t)),
                        ...
                        n.options.endTime && (t.data === YT.PlayerState.PLAYING ? d = setInterval(function() {
                ...
                if (h) {
                    ...
                    f.setAttribute("id", n.playerID),
                    o.appendChild(f),
                    document.body.appendChild(o)
                }
                n.player = n.player || new t.YT.Player(n.playerID,n.playerOptions),
                h && (n.$iframe = document.getElementById(n.playerID),
                n.videoWidth = parseInt(n.$iframe.getAttribute("width"), 10) || 1280,
                n.videoHeight = parseInt(n.$iframe.getAttribute("height"), 10) || 720)
            }
            ...
            n.player.on("timeupdate", function(t) {
                a || n.fire("started", t),
                a = 1,
                n.options.endTime && n.options.endTime && t.seconds >= n.options.endTime && (n.options.loop ? n.play(n.options.startTime) : n.pause())
            }),
            n.player.on("play", function(t) {
                n.fire("play", t),
                n.options.startTime && 0 === t.seconds && n.play(n.options.startTime)
            }),
            ...
            if ("local" === n.type) {
                if (!n.$iframe)
                    for (var p in n.$iframe = document.createElement("video"),
    ...
    if ("undefined" != typeof jarallax) {
        ...
        t.prototype.initImg = function() {
            ...
            t.options.videoSrc) {
                ...
                if (i.isValid() && (t.image.useImgTag = !0,
                i.on("ready", function() {
                    var e = t.onScroll;
                    t.onScroll = function() {
                        e.apply(t),
                ...
                i.on("started", function() {
                    ...
                    t.image.width = t.options.imgWidth = t.video.videoWidth || 1280,
                    t.image.height = t.options.imgHeight = t.video.videoHeight || 720,
                    t.coverImage(),
                    t.clipContainer(),
                    t.onScroll(),
                ...
                t.video = i,
                "local" !== i.type && i.getImageURL(function(e) {
                    t.image.src = e,
                    t.init()
                })),
                "local" !== i.type)
                    return !1;
                if (!e)
                    return t.image.src = "data:image/gif;base64,R0lGODlhAQABAIAAAAAAAP///yH5BAEAAAAALAAAAAABAAEAAAIBRAA7",
                    !0
            }
            return e
        }
